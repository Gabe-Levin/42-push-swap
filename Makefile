...
SRC = main.c stack_utils.c operators/push.c operators/swap.c\
operators/rotate.c operators/rev_rotate.c rotations.c\
read_input.c init_nodes.c push_swap.c set_targets.c\
input_validation.c
